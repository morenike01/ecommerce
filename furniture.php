...
<!-- breadcrumbs -->
	...
	<div>
	<!-- <p style = "font-size: 25px">Add Product</p>
<table border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee" style="text-align:center"> -->
<th colspan="2" align="center">Product Information</th>


<form action ="furniture.php" method = "GET" style="text-align:center">
...
<?php
$mysqli = new mysqli('localhost','store','','root');
...
if(!$obj->add_product($name, $charges, $price,$id)){
...
if($result==false){
    ...
    $row= $result->fetch_assoc();
	 ...
	 <td>PRODUCT NAME</td><td>SERVICE CHARGES</td><td>PRICE</td><td>CATEGORY</td></tr>";
	...
	while($row){
		...
		echo "<td align=left>{$row["service_charges"]}</td>";
